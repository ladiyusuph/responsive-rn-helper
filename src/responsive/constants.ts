import type { Breakpoints, FluidConfig, LayoutConfig, ResponsiveRadiiConfig, ResponsiveSpacingConfig, ResponsiveTypographyConfig } from "./types";

export const DEFAULT_BREAKPOINTS: Breakpoints = { smallPhone: 360, phone: 600, tablet: 840 };

/** Base spacing scale for consumers that want simple, non-responsive values. */
export const DEFAULT_SPACING = { xs: 4, sm: 8, md: 12, lg: 16, xl: 20, xxl: 24, xxxl: 32 } as const;
...
export const DEFAULT_RADII = { sm: 8, md: 12, lg: 16, xl: 20, xxl: 24 } as const;
...
export const DEFAULT_LAYOUT: LayoutConfig = {
  ...
  contentMaxWidth: { small: undefined, phone: undefined, tablet: 800, largeTablet: 1000 },
  gap: { small: 8, phone: 12, tablet: 16, largeTablet: 20 },
  ...
  buttonHeight: { minWidth: 320, maxWidth: 900, minValue: 48, maxValue: 56 } satisfies FluidConfig,
};
